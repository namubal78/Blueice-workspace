...
public class Cancel {
    ...
    public Double cancelPrice; // (선택사항) 부분취소 요청시 금액을 지정, 미지정시 전액 취소 (부분취소가 가능한 PG사, 결제수단에 한해 적용됨)
    public Double cancelTaxFree; // 취소할 비과세 금액
    public String cancelId; // (선택사항) 부분취소 요청시 중복 요청을 방지하기 위한 고유값
    public String cancelUsername; // 취소 요청자 이름
    public String cancelMessage; // 취소 요청 사유

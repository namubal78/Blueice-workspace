...
/**
 * Servlet implementation class MemberListMemNameController
 */
@WebServlet("/memberListMemName.me")
public class MemberListMemNameController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberListMemNameController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountMemName(memName);
		...
		ArrayList<Member> list = new MemberService().selectMemberListMemName(memName, pi);
		...
		request.getRequestDispatcher("views/member/adminMemberMemName.jsp").forward(request, response);

...
/**
 * Servlet implementation class GroupMemberListMemNoController
 */
@WebServlet("/groupMemberListMemNo.me")
public class GroupMemberListMemNoController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupMemberListMemNoController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountGroupMemNo(memNo);
		...
		ArrayList<Member> list = new MemberService().selectGroupMemberListMemNo(memNo, pi);
		...
		request.getRequestDispatcher("views/member/adminGroupMemberMemNo.jsp").forward(request, response);

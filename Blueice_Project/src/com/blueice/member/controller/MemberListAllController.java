...
/**
 * Servlet implementation class MemberListAllController
 */
@WebServlet("/memberListAll.me")
public class MemberListAllController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountAll();
		...
		ArrayList<Member> list = new MemberService().selectMemberListAll(pi);

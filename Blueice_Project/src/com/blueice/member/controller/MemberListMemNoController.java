...
/**
 * Servlet implementation class MemberListMemNoController
 */
@WebServlet("/memberListMemNo.me")
public class MemberListMemNoController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberListMemNoController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountMemNo(memNo);
		...
		ArrayList<Member> list = new MemberService().selectMemberListMemNo(memNo, pi);
		...
		request.getRequestDispatcher("views/member/adminMemberMemNo.jsp").forward(request, response);

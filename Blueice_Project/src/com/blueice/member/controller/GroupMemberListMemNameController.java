...
/**
 * Servlet implementation class GroupMemberListMemNameController
 */
@WebServlet("/groupMemberListMemName.me")
public class GroupMemberListMemNameController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupMemberListMemNameController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountGroupMemName(memName);
		...
		ArrayList<Member> list = new MemberService().selectGroupMemberListMemName(memName, pi);
		...
		request.getRequestDispatcher("views/member/adminGroupMemberMemName.jsp").forward(request, response);

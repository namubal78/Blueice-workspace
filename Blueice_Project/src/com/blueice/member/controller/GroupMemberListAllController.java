...
/**
 * Servlet implementation class GroupMemberListAllController
 */
@WebServlet("/groupMemberListAll.me")
public class GroupMemberListAllController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupMemberListAllController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// * listCount : 총 게시글 갯수
		listCount = new MemberService().selectListCountGroupAll();
		...
		ArrayList<Member> list = new MemberService().selectGroupMemberListAll(pi);
		
		request.setAttribute("pi", pi);
		request.setAttribute("list", list);

		request.getRequestDispatcher("views/member/adminGroupMemberList.jsp").forward(request, response);

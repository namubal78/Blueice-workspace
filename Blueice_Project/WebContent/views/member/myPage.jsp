            ...
            <div id="content_2">
                ...
                <div id="content_2_2">
                    <div id="content_2_2_1">
                        ...
                        <div id="userB">
                            <button type="button" onclick="location.href='<%= contextPath %>/myPage.me'" class="btn btn-primary btn-block btn-lg">회원 정보 조회</button> <br> <%-- 비밀번호 확인 모달창  --%>
                            <button type="button" onclick="location.href='temList.do?currentPage=1'" class="btn btn-primary btn-block btn-lg">나의 일시 후원 조회</button> <br>
                            <button type="button" onclick="location.href='regList.do?currentPage=1'" class="btn btn-primary btn-block btn-lg">나의 정기 후원 조회</button> <br>
                            <button type="button" onclick="location.href='myInquiry.in?currentPage=1'" class="btn btn-primary btn-block btn-lg">1:1 문의 내역</button>
                        </div>
                    </div>
                </div>
            </div>

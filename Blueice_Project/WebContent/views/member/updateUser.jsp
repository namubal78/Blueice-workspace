...
<body>
	...
	<div class="wrap">
        ...
        <%
			// 현재 로그인한 사용자의 정보를 변수로 담기
			// => 아이디, 이메일, 주소1, 주소2
			String memId = loginMember.getMemId();
			String email = loginMember.getEmail();
			String zip = loginMember.getZip();
			String address1 = loginMember.getAddress1();
			String address2 = loginMember.getAddress2();
            ...
            <div id="content_2">
                ...
                <div id="content_2_2">
                    <div id="enroll">
                        ...
                        <div id="enroll-form">
                            <form id="mypage-form" action="<%= contextPath %>/update.me" method="post" align="center">
                                <table>
                                    <tr>
                                        <th>회원/단체명</th>
                                        <td colspan="3"><input type="text" name="memName" id="memName" class="form-control" maxlength="6" required value="<%= loginMember.getMemName() %>" style="width:300px"></td>
                                    </tr>
                                    <tr>
                                        <th>아이디</th>
                                    ...
                                    <tr>
                                        <th>전화번호</th>
                                        <td colspan="3"><input type="text" name="phone" id="phone" class="form-control" value="<%= loginMember.getPhone() %>" style="width:300px"></td>
                                    </tr>
                                    <tr>
                                        <th>이메일</th>
                                ...
                                <div class="btns" align="center">
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#updatePwdForm">비밀번호 변경</button> <!-- 모달창 -->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
            ...
            <form action="<%= contextPath %>/updatePwd.me" method="post" align="center">

...
<%
    ...
    int memNo = request.getAttribute("memNo") == null ? 0 : (int)request.getAttribute("memNo");
	// 자주 쓸 필드값만 미리 빼둠
	                	...
	                	<div id="myDona">
							...
							<div id="donaTable">
								<div class="admin-donation-search" style="z-index:100 !important;">
									<div class="form-group row" style="margin-left: 380px; margin-top: -20px;">
										<div style="margin-right:10px;">
											...
											<select id="selectBox" class="selectpicker show-tick" data-style="btn-primary" data-width="130px" onchange="OnChange();">
												...
												<option value="optionNo" selected>회원 번호</option>
									...
									<div class="input-group" style="width: 250px;">
										<input type="text" id="search2" class="form-control" name="" placeholder="내용을 입력해주세요" value="<%= memNo %>">
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
									<li class="page-item">
										<% if(currentPage != 1){ %>
											<a class="page-link" href="<%= contextPath %>/memberListMemNo.me?currentPage=<%= currentPage - 1 %>" aria-label="Previous">
									...
									<% if(p != currentPage){ %>
									<li class="page-item"><a class="page-link" href="<%= contextPath %>/memberListMemNo.me?currentPage=<%= p %>"><%= p %></a></li>
										<% } else{ %>
									...
									<li class="page-item">  
										<% if(currentPage != maxPage){%>
											<a class="page-link" href="<%= contextPath %>/memberListMemNo.me?currentPage=<%= currentPage + 1 %>" aria-label="Next">

	                	...
	                	<div id="myDona">
									...
									<div class="form-group row" style="margin-left: 380px; margin-top: -20px;">
										<div style="margin-right:10px;">
											...
											<select id="selectBox" class="selectpicker show-tick" data-style="btn-primary" data-width="130px" onchange="OnChange();">
												...
												<option value="optionName" selected>이름</option>
											</select>
										</div>	                                
									<!-- 검색내용 입력 칸 -->
							...
							<nav aria-label="Page navigation example">
								<ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
									<li class="page-item">
										<% if(currentPage != 1){ %>
											<a class="page-link" href="<%= contextPath %>/memberListMemName.me?currentPage=<%= currentPage - 1 %>" aria-label="Previous">
									...
									<% if(p != currentPage){ %>
									<li class="page-item"><a class="page-link" href="<%= contextPath %>/memberListMemName.me?currentPage=<%= p %>"><%= p %></a></li>
										<% } else{ %>
									...
									<li class="page-item">  
										<% if(currentPage != maxPage){%>
											<a class="page-link" href="<%= contextPath %>/memberListMemName.me?currentPage=<%= currentPage + 1 %>" aria-label="Next">

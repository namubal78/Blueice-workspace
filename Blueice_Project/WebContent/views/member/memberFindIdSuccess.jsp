...
<%  Member findIdMember = (Member)request.getAttribute("findIdMember"); %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<style>
    ...
    /* 결과 영역을 비밀번호찾기결과 영역(text_3), 버튼 영역(button)으로 나눔 */
    #form>div { width: 100%; }
                ...
                <div id="content_2_2">
                    ...
                    <div id="contentForm">
                        ...
                        <div id="form" align="center">
                            <div id="text_2">
                                <p>
                                    <span style="color:rgb(40, 78, 122);"><%= findIdMember.getMemName() %></span>님의 아이디는<br>
                                    <span style="color:rgb(40, 78, 122);"><%= findIdMember.getMemId() %></span>입니다.
                                </p>
                            </div>
                            <div id="botton">

<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, com.blueice.common.model.vo.PageInfo, com.blueice.donation.model.vo.Donation, com.blueice.member.model.vo.Member" %>
<% 
...
<style>
    ...
    #donaText_1 { height: 65%; float: left; }
    #donabtn { height: 35%; float: left; }
            ...
            <div id="content_2">
                ...
                <div id="content_2_2">
                    <div id="myDona">
                        <div id="donaText">
                            <div id="donaText_1">
                                <div id="donaText_1_1"><p>나의 일시 후원 내역</p></div>
                                <div id="donaText_1_2"><p>후원 내역을 누르면 해당 내역의 결제 영수증 출력 페이지로 넘어가고<br>
                                영수증 버튼을 누르면 기부금 영수증 페이지로 이동합니다.<br>
                                정기 후원내역은 마이페이지에서 이동하실 수 있습니다.</p></div>
                            </div>
                            <br>
                            <div id="donabtn" style="margin-left:980px">
                                <p> 후원금 영수증 출력</p>
                                <a href="yearReceiptList.do?type=2" target="_blank" class="btn btn-primary" style="background-color: #3970B3;">금년 내역</a>
                                <a href="fullReceiptList.do?type=2" target="_blank" class="btn btn-success">모든 내역</a>
                        ...
                        <div id="donaTable">
                            ...
                            <table class="table table-hover">
                                    ...
                                    <% if(list.isEmpty()) { %>
                                        <!-- 조회된 후원내역이 없을 경우 -->
										<tr>
                                            <td colspan="5">존재하는 후원 내역이 없습니다.</td>
                                        </tr>
                                    <% } else { %>
                                        <% for(int i=0; i<list.size(); i++) { %>
                                            <tr>
                                                ...
                                                <td><%= list.get(i).getDoBill() %></td>
                                                <td><%= list.get(i).getDoDate() %></td>
                                                <td width="15%">
                                                    <a href="oneReceiptList.do?type=2&dId=<%= list.get(i).getDoId() %>" class="btn btn-primary">기부금영수증</a>
                                                </td>
                                                <td id="url" style="display:none;"><%= list.get(i).getReceiptURL() %></td>
                                            </tr>
                                        <% } %>
                                    <% } %>
                                    </tbody>

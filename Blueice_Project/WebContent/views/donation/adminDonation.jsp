...
<div class="wrap">
    ...
    <div id="content">
        ...
        <div id="content_2">
            ...
            <div id="content_2_2">
                <form action="temAdminlist.do?currentPage=1" method="post">
                    <div id="myDona">
                        <div id="donaText"><p>일시 후원 관리</p>
                            <div id="donabtn">
                        ...
                        <div id="donaTable">
                            ...
                            <table class="table table-hover">
                                ...
                                <% for(int i=0; i<list.size(); i++) { %>
                                    <tr>
                                        <td><%= list.get(i).getDonator() %></td>
                                        <% if(list2.get(i).getMemNo() == Integer.parseInt(list.get(i).getDonator())) {%>
                                            <td>
                                        ...
                                        <td>
                                            <a href="oneReceiptList.do?type=2&dId=<%= list.get(i).getDoId() %>" target="_blank" class="btn btn-primary">기부금영수증</a>
                                        </td>
                                    </tr>
                                <% } %>
                                </tbody>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
                                        ...
                                        <li class="page-item">
                                            ...
                                            <a class="page-link" href="<%= contextPath %>/temAdminlist.do?currentPage=<%= pi.getCurrentPage() - 1 %>" aria-label="Previous">
                                        ...
                                        <% for(int p = pi.getStartPage(); p <= pi.getEndPage(); p++){ %>
                                            ...
                                            <% if(p != pi.getCurrentPage()){ %>
                                                <li class="page-item"><a class="page-link" href="<%= contextPath %>/temAdminlist.do?currentPage=<%= p %>"><%= p %></a></li>
                                            <% } else{ %>
                                        ...
                                        <li class="page-item">
                                            ...
                                            <% if(pi.getCurrentPage() != pi.getMaxPage()){%>
                                                <a class="page-link" href="<%= contextPath %>/temAdminlist.do?currentPage=<%= pi.getCurrentPage() + 1 %>" aria-label="Next">

	     ...
	     <div id="content">
	         ...
	         <div id="content_2">
	             ...
	             <div id="content_2_2">
					...
					<div id="main">
                        <div id="notice">
                            <form id="enroll-form" action="<%= contextPath %>/insert.challenge" method="post" enctype="multipart/form-data">

                                <table align="center">
                                    <tr>
                                        <th>제목</th>
                                        <td><input type="text" name="title" class="form-control" required maxlength="33"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>첨부파일</th>
                                        <td><input type="file" name="upfile" required accept="image/jpeg, image/gif, image/png"></td>
                                    </tr>
                                </table>

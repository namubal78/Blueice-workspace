...
<%
	ArrayList<Challenge> chList = (ArrayList<Challenge>)request.getAttribute("chList");

	ArrayList<ChallengeComment> rewardName = (ArrayList<ChallengeComment>)request.getAttribute("rewardName");
%>
<!DOCTYPE html>
<html>
<head>
	     ...
	     <div id="content">
	         ...
	         <div id="content_2">
	             ...
	             <div id="content_2_2">
					...
					<div id="main">
                        <div id="notice">
                            <form id="enroll-form" action="<%= contextPath %>/insert.re" method="post" enctype="multipart/form-data">

                                <table align="center">
                                    <tr>
                                        <th>제목</th>
                                        <td><input type="text" name="chalRewardTitle" class="form-control" required></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td>
                                            <textarea name="chalRewardConts" class="form-control" rows="19" required style="resize:none">
                                            	<%= chList.get(0).getChalTitle() %> 챌린지 당첨자를 발표합니다. <br>
                                            	<% for(int i = 0; i < rewardName.size(); i++) { %>
                                            		<b><%= rewardName.get(i).getMemNo() %></b>
                                            	<% } %>
                                            </textarea>
                                        </td>
                                    </tr>

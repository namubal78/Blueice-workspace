                ...
                <div id="myDona">
                   ...
                   <div class="form-group row" style="margin-left:380px; margin-top:-50px;">
                            <div style="margin-right:10px;">
                                <!-- 검색 카테고리 설정 칸 -->
                                <select id="searchAdmin" name="adminChoice" id="selectBox" class="selectpicker show-tick" data-style="btn-primary" data-width="100px" onchange="return OnChange();">
                               		<option value="category" selected>구분</option>
                                    <option value="answerO">답변완료</option>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <% if(list.isEmpty()) { %>
                                <tr>
                                	<td colspan="5">조회된 리스트가 존재하지 않습니다.</td>
                                </tr>
                                <% } else { %>
                                <% for(Inquiry i : list) { %>
                                <tr>
	                        ...
	                        <nav aria-label="Page navigation example">
	                            <ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <a class="page-link" href="<%= contextPath %>/adminList.in?currentPage=<%= pi.getCurrentPage() - 1 %>" aria-label="Previous">
	                                ...
	                                <% for(int p = pi.getStartPage(); p <= pi.getEndPage(); p++){ %>
	                                	...
	                                	<% if(p != pi.getCurrentPage()){ %>
	                                		<li class="page-item"><a class="page-link" href="<%= contextPath %>/adminList.in?currentPage=<%= p %>"><%= p %></a></li>
	                                	<% } else{ %>
	                                ...
	                                <li class="page-item">
	                                	<% if (pi.getCurrentPage() == 1 && pi.getListCount() < 10) { %>
	                                    <% } else if(pi.getCurrentPage() != pi.getMaxPage()){%>
	                                    	<a class="page-link" href="<%= contextPath %>/adminList.in?currentPage=<%= pi.getCurrentPage() + 1 %>" aria-label="Next">

	     ...
	     <div id="content">
	         ...
	         <div id="content_2">
	             ...
	             <div id="content_2_2">
					...
					<div id="main">
                        <div id="notice">
                            <form id="enroll-form" action="<%= contextPath %>/inquiryInsert.in" method="post">
                            	<input type="hidden" name="memNo" value="<%= loginMember.getMemNo() %>">
                                <table align="center">
                                    <tr>
                                        <th>제목</th>
                                        <td><input type="text" name="title" class="form-control" maxlength="18" required></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td>
                                            <textarea name="content" class="form-control" rows="19" maxlength="1000" required style="resize:none"></textarea>
                                        </td>
                                    </tr>
                                </table>

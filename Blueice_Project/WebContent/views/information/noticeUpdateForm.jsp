<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="com.blueice.information.model.vo.Notice"%>
<!DOCTYPE html>
<% 
//해당 공지사항 게시글 뽑기 
Notice n = (Notice)request.getAttribute("n"); // 키값 -> "n"
                        ...
                        <div id="notice">
                            ...
                            <input type="hidden" name="nno" value="<%= n.getNoticeNo() %>">
                                ...
                                <table align="center">
                                    <tr>
                                        <th>제목</th>
                                        <td><input type="text" name="title" class="form-control" maxlength="33" required value="<%= n.getNoticeTitle() %>"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td>
                                            <textarea name="content" class="form-control" rows="19" required style="resize:none"><%= n.getNoticeContent() %></textarea>
                                        </td>
                                    </tr>
                                </table>

	                        ...
	                        <nav aria-label="Page navigation example">
	                            <ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <a class="page-link" href="<%= contextPath %>/adminMemId.in?currentPage=<%= pi.getCurrentPage() - 1 %>" aria-label="Previous">
	                                ...
	                                <% for(int p = pi.getStartPage(); p <= pi.getEndPage() - 2; p++){ %>
	                                	...
	                                	<% if(p != pi.getCurrentPage()){ %>
	                                		<li class="page-item"><a class="page-link" href="<%= contextPath %>/adminMemId.in?currentPage=<%= p %>"><%= p %></a></li>
	                                	<% } else{ %>
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <% } else if(pi.getCurrentPage() != pi.getMaxPage()){%>
	                                    	<a class="page-link" href="<%= contextPath %>/adminMemId.in?currentPage=<%= pi.getCurrentPage() + 1 %>" aria-label="Next">

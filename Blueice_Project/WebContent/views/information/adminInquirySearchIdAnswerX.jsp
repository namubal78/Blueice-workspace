                   ...
                   <div class="form-group row" style="margin-left:380px; margin-top:-50px;">
                            <div style="margin-right:10px;">
                                ...
                                <select id="searchAdmin" name="adminChoice" class="selectpicker show-tick" data-style="btn-primary" data-width="100px" onchange="return OnChange();">
                                    ...
                                    <option value="answerX" selected>답변대기</option>
	                        ...
	                        <nav aria-label="Page navigation example">
	                            <ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <a class="page-link" href="<%= contextPath %>/adminAnswer.in?currentPage=<%= pi.getCurrentPage() - 1 %>&answer=X" aria-label="Previous">
	                                ...
	                                <% for(int p = pi.getStartPage(); p <= pi.getEndPage() - 2; p++){ %>
	                                	...
	                                	<% if(p != pi.getCurrentPage()){ %>
	                                		<li class="page-item"><a class="page-link" href="<%= contextPath %>/adminAnswer.in?currentPage=<%= p %>&answer=X"><%= p %></a></li>
	                                	<% } else{ %>
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <% } else if(pi.getCurrentPage() != pi.getMaxPage()){%>
	                                    	<a class="page-link" href="<%= contextPath %>/adminAnswer.in?currentPage=<%= pi.getCurrentPage() + 1 %>&answer=X" aria-label="Next">

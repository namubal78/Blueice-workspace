...
<style>
    ...
    #navigator {
        ...
        z-index: 100; /* 페이지 내의 다른 요소보다 항상 위에 뜨도록 설정(모달창 제외) */
    }
...
<script>
	...
	if(msg != "null") {
        ...
        <div id="navigator">
            <div id="navigator_1">
                <a href="<%= contextPath %>"><img src="<%= contextPath %>/resources/images/logo/logo3_1.png" id="logo"></a>
            </div>
            <div id="navigator_2">
                <ul id="navi">
                    <li>
                        <a>소개</a>
                        <ul>
                            <li><a href="<%= contextPath %>/views/information/mission.jsp">이념과 미션</a></li>
                            <li><a href="<%= contextPath %>/views/information/business.jsp">사업</a></li>
                            <li><a href="<%= contextPath %>/peopleLink.in">조직도</a></li>
                            <li><a href="<%= contextPath %>/locationLink.in">오시는 길</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="<%= contextPath %>/faqSelect.in">FAQ</a></li>
            ...
            <div id="navigator_3">
                <p>
                    ...
                    <a href="<%= contextPath %>/myMenu.me">마이페이지</a>
                </p>
            </div>
            <% } %>

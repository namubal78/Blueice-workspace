...
<%
	ArrayList<News> pageList = (ArrayList<News>)request.getAttribute("pageList");
				        	...
				        	<% if(!pageList.isEmpty()) {%>
				        		...
				        		<% for(News n : pageList){ %>
						            <div class="newsfeed">
						                ...
						                <div class="content">
						                	<a href="page.news?nno=<%= n.getNewsNo() %>">
						                		<%= n.getNewsTitle() %>
						                	</a>
						                </div>
	                        ...
	                        <nav aria-label="Page navigation example">
	                            <ul class="pagination" style="justify-content: center;"> <!-- justify-content: center; : 페이징 가운데 정렬-->
	                                ...
	                                <li class="page-item">
	                                    ...
	                                    <a class="page-link" href="<%= contextPath %>/list.news?currentPage=<%= pi.getCurrentPage() - 1 %>" aria-label="Previous">
	                                ...
	                                <% for(int p = pi.getStartPage(); p <= pi.getEndPage(); p++){ %>
	                                	...
	                                	<% if(p != pi.getCurrentPage()){ %>
	                                		<li class="page-item"><a class="page-link" href="<%= contextPath %>/list.news?currentPage=<%= p %>"><%= p %></a></li>
	                                	<% } else{ %>
	                                ...
	                                <li class="page-item">
	                                	<% if(pi.getMaxPage() -1 == pi.getCurrentPage()) { %>
	                                	
	                                    <% } else if(pi.getCurrentPage() != pi.getMaxPage()){%>
	                                    	<a class="page-link" href="<%= contextPath %>/list.news?currentPage=<%= pi.getCurrentPage() + 1 %>" aria-label="Next">
